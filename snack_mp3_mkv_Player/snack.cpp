...
int main(void) {
	...
	gotoxy(i, -1, 0, "┐");
	gotoxy(i, SIZE, 0, "┘");
	gotoxy(SIZE + 2 + 5, 1, 0, "W = 上");
	gotoxy(SIZE + 2, 2, 0, "A = 左  S = 下  D = 右");
	gotoxy(SIZE + 2 + 3, 3, 0, "以外 　= STOP");
